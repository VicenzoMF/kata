...
- The exported core API lives in
  ...
  auth helpers under [`@katajs/core/jwt`](https://github.com/VicenzoMF/kata/blob/main/packages/kata/src/jwt/index.ts).
...
`./context`, never from `@katajs/core` directly:
...
[built-in middleware](/reference/middleware), and [`@katajs/core/jwt`](/reference/jwt).
:::
