...
- The exported core API lives in
  ...
  auth helpers under [`@katajs-framework/core/jwt`](https://github.com/VicenzoMF/kata/blob/main/packages/kata/src/jwt/index.ts).
...
`./context`, never from `@katajs-framework/core` directly:
...
[built-in middleware](/reference/middleware), and [`@katajs-framework/core/jwt`](/reference/jwt).
:::
