...
| Async providers & lifecycle hooks (`OnModuleInit`, `OnApplicationShutdown`) | No container to drive a lifecycle | Eager `singleton` factories at startup; shutdown via process signals in `main.ts` |
