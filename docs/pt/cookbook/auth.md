...
A Kata entrega os blocos de construção de JWT em [`@katajs-framework/core/jwt`](/adr/0013-jwt-delivery),
...
A Kata entrega três guard handlers em `@katajs-framework/core/jwt`:
