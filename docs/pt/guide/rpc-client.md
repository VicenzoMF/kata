...
::: tip
`KataApp` é exportado de `@katajs/core` se você quiser nomear o tipo explicitamente:
...
`ErrorBodySchema` (exportado de `@katajs/core`) é o schema canônico do envelope de erro do
