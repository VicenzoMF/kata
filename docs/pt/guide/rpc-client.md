...
::: tip
`KataApp` é exportado de `@katajs-framework/core` se você quiser nomear o tipo explicitamente:
...
`ErrorBodySchema` (exportado de `@katajs-framework/core`) é o schema canônico do envelope de erro do
