          ...
          '/pt/cookbook/': [
            {
              ...
              items: [
                ...
                { text: 'Logging', link: '/pt/cookbook/logging' },
          ...
          '/pt/reference/': [
            {
              ...
              items: [
                ...
                { text: '@katajs-framework/core/jwt', link: '/pt/reference/jwt' },
              ],
            },
          ],
        },
      ...
      '/cookbook/': [
        {
          ...
          items: [
            ...
            { text: 'Logging', link: '/cookbook/logging' },
      ...
      '/reference/': [
        {
          ...
          items: [
            ...
            { text: '@katajs-framework/core/jwt', link: '/reference/jwt' },
          ],
        },
      ],
      '/adr/': [
